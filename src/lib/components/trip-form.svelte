	...
	<div class="p-8">
		...
		<Tabs bind:value={activeTab} class="w-full">
			<TabsList class="mb-8 grid w-full grid-cols-5">
				...
				<TabsTrigger value="itinerary" class="flex items-center gap-2">
				...
				<TabsTrigger value="accommodations" class="flex items-center gap-2">
					<Building class="h-4 w-4" />
					Hotels
				</TabsTrigger>
				<TabsTrigger value="transportation" class="flex items-center gap-2">
					<Plane class="h-4 w-4" />
					Transport
				</TabsTrigger>
			</TabsList>
					...
					<CardContent class="space-y-4">
						<div class="grid grid-cols-1 gap-4 md:grid-cols-2">
							<div class="space-y-2">
								...
								<Input id="title" bind:value={tripData.title} placeholder="Amazing Journey to..." />
							</div>
							<div class="space-y-2">
								<Label for="location">Location</Label>
								<Input
									id="location"
									bind:value={tripData.location}
						...
						<div class="space-y-2">
							...
							<Input id="dates" bind:value={tripData.dates} placeholder="June 15-22, 2024" />
						</div>
						<div class="space-y-2">
							<Label for="headerImage">Header Image URL</Label>
							<Input id="headerImage" bind:value={tripData.headerImage} placeholder="https://..." />
						</div>
						<div class="space-y-2">
