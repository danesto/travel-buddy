...
<div class="min-h-screen">
	...
	{:then trip}
		{#if trip}
			<!-- Header Image -->
			<div
				class="text-tight relative flex h-80 w-full items-center justify-center rounded-sm font-serif text-5xl tracking-tight text-gray-200"
				style="background-color: {trip?.accentColor}"
			>
				{trip?.title}
			</div>

			<!-- Main Content -->
			<div class="relative z-10 mx-auto -mt-12 max-w-4xl px-4">
				<!-- Title Card -->
				<div
					class="mb-8 w-full rounded-2xl border bg-white p-8"
					style="border-color: {trip?.accentColor}"
				>
						...
						<div class="w-full">
							...
							<div class="flex items-center gap-4 pb-4">
								<Button
									...
									class="pl-0 text-base text-green-700"
								>
									Itenirary
								</Button>
								<Button
					...
					<p class="text-lg leading-relaxed text-gray-600">{trip.summary}</p>
				</div>
